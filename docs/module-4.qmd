...
[![Click the image to view the cells in Neuroglancer.](resources/module_4_celltypes_cover.png){fig-align="center"}](https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-4-celltypes-cover.json)
:::
...
:::{.callout-note}
## Dataset versions and the root-ID warning

Both Dash Apps will update the given Root ID to match the version selected in their drop down. 
If the ID you provide doesn't match the version selected, the root will update and you will see a 
**yellow warning banner**. This warning is fine — it is telling you the app substituted the correct Root
ID for the version you queried. You do not need to do anything about it.

Two things to keep in mind:

- The **Materialization dropdown defaults to "Latest"**, not to the version used by
  the previous links in these modules. If you want your Dash App
  results to match the cells shown in the module links, select **v1300** in the
  Materialization dropdown.
- Neuroglancer links generated *from* the Dash Apps use the dynamic (Graphene)
  segmentation layer, not the static layer used in the module scenes.

The difference between the static and dynamic (Graphene) layers, and why versions
matter, is explained in the [Troubleshooting FAQ](faq.qmd#graphene).
:::
...
First, we will look at some cortico-cortical pyramidal cells. These are excitatory neurons that project to other cortical regions. The following link will take you to a Neuroglancer window containing a selection of Layer 2 Pyramidal Cells: [Layer 2 Pyramidal Cells](https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-4-layer2-pyramidal.json)

You can also cut and paste the following URL into your browser:

> <https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-4-layer2-pyramidal.json>
...
Next, we will look at some Layer 6 corticothalamic pyramidal cells. These are excitatory neurons that project from the visual cortex back to the thalamus to provide feedback within the visual system. The following link will take you to a Neuroglancer window containing a selection of Layer 6 Pyramidal Cells: [Layer 6 Pyramidal Cells](https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-4-layer6-corticothalamic.json)

You can also cut and paste the following URL into your browser:

> <https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-4-layer6-corticothalamic.json>
...
Finally, we will look at some inhibitory cell populations in the dataset. The following Neuroglancer link displays Basket Cells and Chandelier Cells, two of the well-described inhibitory interneuron cell types. These cells release GABA to inhibit the activity of their synaptic targets. [Basket and Chandelier Cells](https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-4-basket-chandelier.json)
