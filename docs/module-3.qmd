...
[![Click the image to view the cells in Neuroglancer.](resources/module_3_spines_cover.png){fig-align="center"}](https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-3-spines-cover.json)
:::
...
> <https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-3-known-inputs.json>
...
:::{.callout-note}
If a **yellow warning banner** appears after you submit, that is fine! The Table Viewer automatically 
substitutes correct Root ID for the version it is has selected in the dropdown. The **Materialization**
version defaults to "Latest"; the neurons in this module's Neuroglancer scenes are
from version **v1300**, so select v1300 if you want the results to match exactly.
More on dataset versions is in the [Troubleshooting FAQ](faq.qmd#versions).
:::
