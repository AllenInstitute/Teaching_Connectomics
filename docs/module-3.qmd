...
![](resources/module_3_spines_cover.png){fig-align="center"}
...
[Student task #1: Zoom into the 3D viewer panel and take a zoomed-in screen shot of dendritic spines that closely resemble each of the four types of spines (mushroom, thin, stubby, and filopodia). ]{.mark}

[Student task #2: With your lab partner, consider how easy or hard it was to determine what type of spine you were looking at.]{.mark} Was it ambiguous or clear? How did you ultimately come up with your classification? What morphological aspects helped you decide which type of spine you were looking at?

### Axons vs Dendrites

Upon close inspection of this neuron, you can observe that not every process extending form the soma contains spines. This is because only dendrites have spines – axons do not. Below (right) is a pseudocolored representation of this pyramidal neuron where the dendrites are colored red, and the axons are colored blue. If you zoom in on the location highlighted with the dashed circle, you can see something that looks like this

![](resources/dendrite_vs_axon.png){fig-align="center"}

[Student task #3: Think about the function of the axon and the dendrite and speculate why axons do not have spines, while dendrites do. ]{.mark} What aspects of the structure and function of axons, compared to dendrites, do you think is important to consider?
...
[Student task #4: Zoom into the 3D panel and locate the axon hillock of this neuron.]{.mark} Remember, both dendrites and axons extend forth from the soma, but the axon will not have any spines. Zoom into the neuron and center the axon hillock within your panel. Take a screen shot of this view that highlights the axon hillock. 

[Student task #5: Consider four hypothetical synaptic sites below: ]{.mark} 
...
![](resources/module_3_neuroglancer_5.png){fig-align="center"}
...
[Student task #6: This pyramidal neuron is excitatory. What neurotransmitter does this neuron most likely secrete from these presynaptic terminals? ]{.mark}
...
[Student task #8: Zoom out in the 3D viewer so that you can compare these two neurons. ]{.mark} How does this new presynaptic neuron (in color) compare to the pyramidal neuron (gray) we have been looking at? Does the presynaptic neuron contain any similar or different properties? Does it have spines?
...
![](resources/module_3_neuroglancer_10.png){fig-align="center"}
...
[Student task #9: Now, it’s your turn to explore the presynaptic partners onto this pyramidal neuron. ]{.mark} Using the cyan, yellow, or pink dots as your guide, right click on the presynaptic partner for synapses on:
...
[Student task #10: Examine the identities of the presynaptic neurons and where they form synapses on the pyramidal neuron. ]{.mark} Do you notice any relationship between neuron type and synapse location? Which inputs are excitatory and which are inhibitory? Based on their location, which neurons are likely to have the greatest influence on whether the pyramidal neuron fires an action potential?
