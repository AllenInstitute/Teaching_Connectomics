...
Figure 1. The position and orintation of the MICrONS dataset in the mouse brain. The lower panel shows a top view of the dataset with cortical area boundaries indicated by black lines (VISp, primary visual cortex; VISrl, rostro lateral visual cortex; VISal anterolateral visual cortex; VISlm lateromedial visual cortex) 
...
Figure 2. Organization of cortical neurons into columns and layers. Layer 1 is the most superficial layer, positioned at the cortical surface. Layer 6 is the deepest layer, positioned adjacent to the white matter.
...
Figure 4. Layered organization of the cortex and apical/basal organization of neurons.(Adapted from Springer Nature Encyclodia of Neuroscience and [@Bekkers_2011])
...
Figure 5. A Layer 5 cortical pyramidal neuron. (after [@Bekkers_2011])
...
Figure 6. Visualization of the V1 (blue circles) and HVA (green circles) column boundaries.
...
Figure 7. Visualization of cortical region borders.
...
Figure 8. Visualization of a cortico-cortical projection neuron.
