...
runningtitle: "HIVE — Module 1: Neuroanatomy"
version: "v1.2 — September 2026"
coverimage: "resources/microns_in_ccf.png"
...
![Figure 1. The position and orientation of the MICrONS dataset in the mouse brain. The lower panel shows a top view of the dataset with cortical area boundaries indicated by black lines (VISp, primary visual cortex; VISrl, rostro lateral visual cortex; VISal anterolateral visual cortex; VISlm lateromedial visual cortex) ](resources/microns_volume_topdown.png) 
...
The body axis and neuraxis of organisms with four or more legs, such as dogs or rodents, share the same plane. This differs from the human body, in which the neuroaxis is rotated 90° from the plane of the body axis (Figure 3).  
...
![Figure 4. Layered organization of the cortex and apical/basal organization of neurons.(Adapted from Springer Nature Encyclopedia of Neuroscience and [@Bekkers_2011])](resources/bekkers_pyramidal_layers.png)
...
You may be prompted for a login. Click 'Request Login' to trigger Google authentication. **You may use any Google account**. However, to activate your access you need to accept the MICrONS Terms of Service. 

Go here: <https://global.daf-apis.com/sticky_auth/api/v1/tos/2/accept> to accept the TOS, or check if you have already done so.

You only need to accept TOS once per account. 
:::


Access Neuroglancer by clicking on the following link:

> <https://spelunker.cave-explorer.org/#!middleauth+https://global.daf-apis.com/nglstate/api/v1/5796589900660736>
...
* You can also {{< kbd win=Right-Click mac=Ctrl-Click >}} on any of the segment IDs listed in the options panel to center the view on that neuron segment (if you are zoomed far out, this may not be obvious)
...
> <https://spelunker.cave-explorer.org/#!gs://microns-static-links/mm3/education/module-1-v1-hva-columns.json> 
...
| `864691135816565839` | Primary visual cortex | Layer 2/3           | HVA Column      | Cortico-cortical projection |
| `864691136991390869` |                       |                     |                 |                             |
| `864691135508871945` |                       |                     |                 |                             |
| `864691135479404742` |                       |                     |                 |                             |
| `864691135082864887` |                       |                     |                 |                             |
...
: {.bordered tbl-colwidths="[40,13,13,13,21]"}
