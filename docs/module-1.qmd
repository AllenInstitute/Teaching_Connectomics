...
You may be prompted for a login. Click 'Request Login' to trigger Google authentication. **You may use any google account**. However, to activate your access you need accept the MICrONS Terms of Service. 

Go here: <https://global.daf-apis.com/sticky_auth/api/v1/tos/2/accept> to accept to TOS, or check if you have already done so.
