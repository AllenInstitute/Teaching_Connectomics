...
runningtitle: "HIVE — Module 2: Ultrastructure"
version: "v1.0 — June 2026"
coverimage: "resources/module_2_em_cover.png"
...
:::{.task}
Find three more mitochondria in the dataset, click on the point annotation tool and hold {{< kbd Ctrl+Left-Click >}} on the raw EM image, and add an annotation point to the mitochondria you have found. Then, add an estimation of its size in the description field for each annotation.
:::   
...
:::{.task}
Find three more primary cilia in the dataset and annotate them using the annotation point tool and holding {{< kbd Ctrl+Left-Click >}}. For each cilium, you should determine the approximate length of the cilium, and place that estimation in the description field for each primary cilium annotation.
:::
...
:::{.task}
Find three more myelinated axons in the dataset and annotate them using the annotation point tool and holding {{< kbd Ctrl+Left-Click >}}. For each axon, determine the approximate diameter of the axon (including the myelin sheath), and place that estimation in the description field for each annotation.
:::
...
:::{.task}
Find three more synapses in the dataset and annotate them using the annotation point tool and holding {{< kbd Ctrl+Left-Click >}}. For each synapse, determine the approximate width of the pre- and post-synaptic contact, and place that estimation in the description field for each annotation.
::: 
...
:::{.task}
Find three interesting structures in the dataset and annotate them using the annotation point tool and holding {{< kbd Ctrl+Left-Click >}} (within the synapse layer panel). For each interesting structure, add “interesting structure” to the description field for each annotation.
:::
