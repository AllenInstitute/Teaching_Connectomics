...
![Figure 1. (A) Schematic representation of the cell body, dendrites, and axon of a neuron. (B) Representation of a neuron’s interactions with other nervous system cell types. Source: Luo, 2016 ](resources/luo_neuron_schematic.png) 
...
![Figure 4. Electron micrographs of chemical (A) and electrical (B) synapses. Mitochondria are indicated by asterisks. In the left panel, the pink arrow indicates a synaptic vesicle. In the right panel, the pink arrows indicate a cell-cell junction between neurons. Source: Luo, 2016](resources/luo_synapses.png)
