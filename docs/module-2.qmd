...
{{< kbd win=Right-Click  mac=Ctrl-Click >}}  on each of the cilia annotations to center the cilia in the image viewer. Zoom in and out to get a sense for where this structure is found. They are most easily located by zooming in and rotating within the segmentation panel.
...
[Find three more primary cilia in the dataset and annotate them using the annotation point tool and holding {{< kbd Ctrl+Left-Click >}} ]{.mark} . For each cilium, you should determine the approximate length of the cilium, and place that estimation in the description field for each primary cilium annotation.
